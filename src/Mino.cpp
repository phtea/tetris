...
void Mino::setColor() {
    static const std::unordered_map<MinoType, SDL_Color> colorMap = {
        {MinoType::I, {0, 255, 255, 255}}, {MinoType::J, {0, 0, 255, 255}},
        {MinoType::L, {255, 165, 0, 255}}, {MinoType::O, {255, 255, 0, 255}},
        {MinoType::S, {0, 255, 0, 255}},   {MinoType::T, {128, 0, 128, 255}},
        {MinoType::Z, {255, 0, 0, 255}}};
    // careful! we get the color without checking if it exists
    m_color = colorMap.at(m_type);
}

void Mino::setShape(int newRotation) { m_blocks = shapes.at(m_type)[newRotation]; }
